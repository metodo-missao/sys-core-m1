// dados-constitucional-advocacia-defensoria.js
async function carregarQuestoes() {
    const { data, error } = await supabaseClient
        .from('constitucional_advocacia_defensoria') // Nome da Tabela no Supabase
        .select('*')
    ...
    const questoesFormatadas = data.map(q => ({
        titulo: `Questão ${q.numero_da_questao.toString().padStart(2, '0')} (Inédita/Carreiras Policiais - 2026) - Direito Constitucional - Advocacia e Defensoria Pública (Art. 131 ao 134)`,
