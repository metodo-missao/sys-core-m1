// dados-legislacao-maria-da-penha.js
async function carregarQuestoes() {
    const { data, error } = await supabaseClient
        .from('legislacao_maria_penha_preliminares') // Nome da Tabela no Supabase
        .select('*')
    ...
    const questoesFormatadas = data.map(q => ({
        titulo: `Questão ${q.numero_da_questao.toString().padStart(2, '0')} (Inédita/Carreiras Policiais - 2026) - Legislação Especial - Lei Maria da Penha (Art. 1º ao 7º)`,
